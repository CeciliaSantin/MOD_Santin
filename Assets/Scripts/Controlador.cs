	...
	public void CambiarEscena(){
        ...
        if (ContarHijos(HijosGanados) >= 0 && ContarHijos(HijosGanados) <= 2)
        {
            switch (GetRandom(0, 7))
            {
                ...
                case 2:
                    SceneManager.LoadScene("perfil2");
                    break;

                case 3:
                    SceneManager.LoadScene("perfil3");
                    break;
                case 4:
                    SceneManager.LoadScene("perfil7");
                    break;
                case 5:
                    SceneManager.LoadScene("perfil8");
                    break;
                case 6:
                    SceneManager.LoadScene("perfil9");
                    break;
                case 7:
                    SceneManager.LoadScene("perfil10");
                    break;

                    //int perfilesIndice = GetRandom(1, 3);
